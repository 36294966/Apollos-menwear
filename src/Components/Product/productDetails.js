...
const products = [
  ...
  // Casual
  { id: 102, name: '🔥Urban Streetwear Shirt', price: 1700, description: '🌟 Adjustable Fit: Perfect for all waist sizes with a reliable, sturdy buckle that ensures comfort and security.', category: 'Cassual Shirt', image: Cassual1},
  { id: 103, name: '🔥Designer Denim Casual', price: 1700, description: '🌟 Adjustable Fit: Perfect for all waist sizes with a reliable, sturdy buckle that ensures comfort and security.', category: 'Cassual Shirt', image: Cassual2},
  { id: 104, name: '🔥Premium Linen Blend', price: 1700, description: '🌟 Adjustable Fit: Perfect for all waist sizes with a reliable, sturdy buckle that ensures comfort and security.', category: 'Cassual Shirt', image: Cassual3},
...
const ProductDetail = () => {
  ...
  const handlePurchase = (item) => {
    ...
    const purchaseItem = { ...item, size: itemSize };
